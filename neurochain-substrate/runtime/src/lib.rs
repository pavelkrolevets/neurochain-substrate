...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("neurochain-substrate"),
	impl_name: create_runtime_str!("neurochain-substrate"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
impl neurochain::Trait for Runtime{
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		NeurocainModule: neurochain::{Module, Call, Storage, Event<T>},
	}
);
